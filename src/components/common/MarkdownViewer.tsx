    ...
    <div className="text-black text-sm/6">
      <Markdown
        components={{
          ...
          a: (props) => <a className="text-blue-600 underline hover:text-blue-800" target="_blank" {...props} />,
          ...
          code: ({ children, className }) => {
            ...
            return (
              <code className="bg-gray-100 px-1 py-0.5 rounded text-xs font-mono text-primary-700">
                {codeString}
              </code>
            );
          },
