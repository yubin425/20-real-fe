  ...
  return (
    <>
      ...
      <div className="px-4 pb-2">
        <h1 className="text-xl font-bold text-gray-800" data-testid='post-title'>{title}</h1>
        <div className="flex items-center justify-between mt-2">
          <div className="flex items-center text-sm text-gray-500">
            ...
            {viewCount !== null && (
              <>
                <span className="font-medium text-primary-500" data-testid='post-viewCount'>조회수 {viewCount}</span>
                <span className="mx-1">•</span>
              </>
            )}
          ...
          {originalUrl && platform && (
            <Button variant="plain" size="sm" className="flex items-center bg-indigo-50 rounded-full" data-testid='post-platform'>
